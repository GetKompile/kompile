...
class ComputeGraphExecutionTest {
    ...
    class ComplexWorkflows {
        ...
        void testETLPipeline_extractTransformLoad() {
            ...
            ComputeGraph graph = ComputeGraph.builder()
                    ...
                    .nodes(List.of(
                            ComputeNode.builder()
                                    ...
                                    .name("Parse Input")
                                    .executionType(NodeExecutionType.JAVASCRIPT)
                                    .script("({name: raw.split(',')[0], value: parseInt(raw.split(',')[1])})")
                                    .build(),
                            ComputeNode.builder()
                                    .id("validate")
                                    .name("Validate")
                                    .executionType(NodeExecutionType.EXPRESSION)
                                    .script("#valid = #value != null && #value > 0; #errorMsg = #valid ? null : 'invalid value'")
                                    .build(),
                            ComputeNode.builder()
                                    .id("enrich")
                                    .name("Enrich")
                                    .executionType(NodeExecutionType.JAVASCRIPT)
                                    .script("({enrichedName: name.toUpperCase(), normalizedValue: value / 100.0, " +
            ...
            assertTrue(record.startsWith("WIDGET:"));
            assertTrue(record.contains("50")); // 5000/100 = 50.0
        }
