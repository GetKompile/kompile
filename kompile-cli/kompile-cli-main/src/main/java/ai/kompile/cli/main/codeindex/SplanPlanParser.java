...
/**
 * Hand-written recursive-descent parser for splan documents.
 * Mirrors the server-side {@code ai.kompile.codeindexer.splan.SplanPlanParser}
 * so that the CLI can parse splan files without depending on the
 * kompile-code-indexer module or the ANTLR runtime.
 *
 * <p>Splan is a "Semantic Plan" DSL for batch code operations.
 * A plan consists of sections (separated by {@code ---}), each
 * containing declarations ({@code :name:::content:::}) and
 * operations ({@code command arg1 arg2 ...}).</p>
 */
public class SplanPlanParser {
    ...
    /**
     * Parse an splan document from text.
     */
