...
public class Nd4jClassLoadingPomFileAppender implements PomFileAppender {
    @Override
    public DependencyType dependencyType() {
        return DependencyType.ND4J_CLASSLOADING;
    }

    @Override
    public List<String> classesToAppend() {
        return Arrays.asList("org.nd4j.common.config.ND4JClassLoading","org.nd4j.common.base.Preconditions");
    }
