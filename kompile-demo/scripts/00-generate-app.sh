...
# 00-generate-app.sh
#
# Regenerate the demo RAG project under generated/demo/project using the kompile
...
#
# This script is the source of truth for the generated project. Anything you'd
# want to change about the generated POM / application.properties belongs in the
# kompile CLI generators (PomModelBuilder, ApplicationPropertiesGenerator), not
# in patches applied after this script runs.
...
# --outputDir is the *base* directory; the CLI creates ${outputDir}/${configName}/project
# under it. So pointing it at generated/ produces generated/demo/project.
