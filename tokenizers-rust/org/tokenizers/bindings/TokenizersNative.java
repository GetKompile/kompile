...
package org.tokenizers.bindings;

import java.nio.*;
import org.bytedeco.javacpp.*;
import org.bytedeco.javacpp.annotation.*;

public class TokenizersNative extends org.tokenizers.presets.TokenizersHelper {
    static { Loader.load(); }
 ...
 */
public native @Cast("OpaqueEncoding**") @Name("encode_batch") PointerPointer encodeBatch(OpaqueTokenizer tokenizer, @Cast("const char**") PointerPointer texts, @Cast("size_t") long num_texts, @Cast("bool") boolean add_special_tokens);
public native @ByPtrPtr @Name("encode_batch") OpaqueEncoding encodeBatch(OpaqueTokenizer tokenizer, @ByPtrPtr @Cast("char*") BytePointer texts, @Cast("size_t") long num_texts, @Cast("bool") boolean add_special_tokens);
public native @ByPtrPtr @Name("encode_batch") OpaqueEncoding encodeBatch(OpaqueTokenizer tokenizer, @ByPtrPtr @Cast("char*") String texts, @Cast("size_t") long num_texts, @Cast("bool") boolean add_special_tokens);
 ...
 */
public native @Name("free_embedded_models") void freeEmbeddedModels(@Cast("const char**") PointerPointer models, @Cast("size_t") long num_models);
public native @Name("free_embedded_models") void freeEmbeddedModels(@ByPtrPtr @Cast("char*") BytePointer models, @Cast("size_t") long num_models);
public native @Name("free_embedded_models") void freeEmbeddedModels(@ByPtrPtr @Cast("char*") String models, @Cast("size_t") long num_models);
