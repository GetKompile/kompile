...
@CommandLine.Command(name = "query", description = "Query the RAG application.")
public class AppQueryCommand implements Callable<Integer> {

    @CommandLine.Option(names = {"--text", "-t"}, description = "Query text", required = true)
    private String text;
    ...
    public Integer call() throws Exception {
        ...
        try {
            ...
            String result = client.postString("/api/rag/query", body);
