...
public class QueryGeneratorUtils {
  ...
  static BooleanClause.Occur getBooleanClauseShould() {
    return BooleanClause.Occur.SHOULD;
  }

  static BooleanClause.Occur getBooleanClauseMust() {
    return BooleanClause.Occur.MUST;
  }

  static BooleanClause.Occur getBooleanClauseMustNot() {
    return BooleanClause.Occur.MUST_NOT;
  }

  static BooleanClause.Occur getBooleanClauseFilter() {
