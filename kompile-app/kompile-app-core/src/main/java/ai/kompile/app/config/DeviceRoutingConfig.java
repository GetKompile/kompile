...
public record DeviceRoutingConfig(
    ...
    public static final String SERVICE_GRAPH = "graph";
    public static final String SERVICE_TRAINING = "training";
    public static final String SERVICE_SERVING = "serving";
    public static final String SERVICE_PIPELINE_SERVING = "pipelineServing";
