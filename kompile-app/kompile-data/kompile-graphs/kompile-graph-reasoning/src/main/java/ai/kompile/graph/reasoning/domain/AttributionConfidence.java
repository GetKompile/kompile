...
public enum AttributionConfidence {
    ...
    // ─── Bridge methods (added for StrengthBand interop) ─────────────────────

    /**
     * Convert this AttributionConfidence to the unified StrengthBand.
     * Delegates to StrengthBand.fromAttributionConfidence(this).
     */
    public ai.kompile.graph.reasoning.confidence.StrengthBand toStrengthBand() {
        return ai.kompile.graph.reasoning.confidence.StrengthBand.fromAttributionConfidence(this);
    }
}
