...
public class DocumentManagementController {
                    ...
                    try {
                        ...
                        for (int chunkSize : chunkSizes) {
                            ...
                            try {
                                ...
                                List<Document> chunks = chunker.chunk(testDoc, chunkingOptions);
                        ...
                        for (TextChunker chunker : textChunkers) {
                            ...
                            if (!isNoOpChunker(chunker)) {
                                try {
                                    ...
                                    List<Document> chunks = chunker.chunk(loadedDocuments.get(0), chunkingOptions);
    ...
    private DocumentProcessingResult processUploadedFile(Path filePath, String loaderName, String chunkerName) throws Exception {
        ...
        List<Document> finalDocuments = new ArrayList<>(loadedDocuments);
        ...
        if (selectedChunker != null) {
            ...
            for (int i = 0; i < loadedDocuments.size(); i++) {
                ...
                try {
                    ...
                    List<Document> chunks = selectedChunker.chunk(doc, chunkingOptions);
