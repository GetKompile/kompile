 ...
 *
 * A note can cite multiple source passages, and this entity tracks those citations
 * using the same SourceMetadataConstants keys as the rest of the retrieval pipeline.
 *
 * Populated optionally by {@code NoteService.linkNoteToSource}. Foundation for
 * future annotation/highlighting features.
 */
@Entity
