...
var draw = /* @__PURE__ */ __name(function(text, id, _version, diagObj) {
  ...
  const sankey = Sankey().nodeId((d) => d.id).nodeWidth(nodeWidth).nodePadding(nodePadding + (showValues ? 15 : 0)).nodeAlign(nodeAlign).extent([[0, 0], [width, height]]);
  sankey(graph);
...
//# sourceMappingURL=chunk-JYNTT5BY.js.map
