...
} from "./chunk-S7FBGI7R.js";
import {
  configureLabelImages,
  getSubGraphTitleMargins
} from "./chunk-R5GVQLC2.js";
import {
  createText
...
var insertEdgeLabel = /* @__PURE__ */ __name((elem, edge) => __async(null, null, function* () {
  ...
  if (edge.startLabelRight) {
    ...
    const startLabelElement = yield createLabel_default(inner, edge.startLabelRight, edge.labelStyle);
    fo = startLabelElement;
    let slBox = startLabelElement.getBBox();
    if (useHtmlLabels) {
      const div = startLabelElement.children[0];
  ...
  if (edge.endLabelLeft) {
    ...
    const endLabelElement = yield createLabel_default(endEdgeLabelLeft, edge.endLabelLeft, edge.labelStyle);
    fo = endLabelElement;
  ...
  if (edge.endLabelRight) {
    ...
    const endLabelElement = yield createLabel_default(endEdgeLabelRight, edge.endLabelRight, edge.labelStyle);
    fo = endLabelElement;
    let slBox = endLabelElement.getBBox();
    if (useHtmlLabels) {
      const div = endLabelElement.children[0];
...
//# sourceMappingURL=chunk-IVUBWDZF.js.map
