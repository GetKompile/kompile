...
function arc_default() {
  ...
  function arc() {
    ...
    if (!(r1 > epsilon3)) context.moveTo(0, 0);
      ...
      var a01 = a0, a11 = a1, a00 = a0, a10 = a1, da0 = da, da1 = da, ap = padAngle.apply(this, arguments) / 2, rp = ap > epsilon3 && (padRadius ? +padRadius.apply(this, arguments) : sqrt(r0 * r0 + r1 * r1)), rc = min2(abs(r1 - r0) / 2, +cornerRadius.apply(this, arguments)), rc0 = rc, rc1 = rc, t03, t13;
      if (rp > epsilon3) {
...
function drag_default() {
  ...
  drag.filter = function(_) {
    return arguments.length ? (filter2 = typeof _ === "function" ? _ : constant_default5(!!_), drag) : filter2;
  };
...
function add(tree, x4, y4, d) {
  ...
  var parent, node = tree._root, leaf = {
    data: d
  }, x0 = tree._x0, y0 = tree._y0, x1 = tree._x1, y1 = tree._y1, xm, ym, xp, yp, right2, bottom2, i, j;
...
function link_default(links) {
  var id2 = index, strength = defaultStrength, strengths, distance = constant_default7(30), distances, nodes, count2, bias, random, iterations = 1;
  if (links == null) links = [];
...
//# sourceMappingURL=chunk-27GZJSOC.js.map
