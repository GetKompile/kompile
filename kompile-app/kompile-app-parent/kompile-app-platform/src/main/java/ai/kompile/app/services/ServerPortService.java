...
public class ServerPortService {
    ...
    /**
     * Get the MCP protocol SSE endpoint URL — the address MCP clients (spawned CLI agents,
     * external tools) connect to. Path mirrors the default of McpServerProperties.Sse#endpoint.
     *
     * @return the MCP SSE URL (e.g., "http://localhost:8080/mcp/sse")
     */
    public String getMcpSseUrl() {
        return getBaseUrl() + "/mcp/sse";
    }
}
