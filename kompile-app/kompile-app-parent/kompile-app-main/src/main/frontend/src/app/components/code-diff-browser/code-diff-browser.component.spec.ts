...
import { GitDiffService, GitCommit, GitFileDiff } from '../../services/git-diff.service';
import { DiffIndexService, DiffSession, DiffIndexEntry } from '../../services/diff-index.service';
