...
public class CliAgentAvailabilityAdapterImpl implements CliAgentAvailabilityAdapter {
    ...
    public void setActiveExtractionPolicy(List<String> providerAllow, List<String> excludeMarkers,
        ...
        try {
            cliAgentModelService.setActiveExtractionPolicy(providerAllow, excludeMarkers, modelAllow);
            log.debug("Applied extraction policy: providerAllow={}, excludeMarkers={}, modelAllow={}",
    ...
    /**
     * Resolve the name of the primary CLI agent eligible for extraction.
     * Returns the first non-api agent that passes {@link #isExtractionAgent(String)},
     * or {@code null} if none is registered.
     */
    private String resolveExtractionAgentName() {
        try {
