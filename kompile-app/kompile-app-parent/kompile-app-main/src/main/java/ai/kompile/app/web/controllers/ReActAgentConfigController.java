...
import ai.kompile.app.web.dto.reactagent.*;
...
public class ReActAgentConfigController {
    ...
    public ResponseEntity<ReActConfigDto> getConfig() {
        ReActConfigDto config = ReActConfigDto.builder()
                ...
                .graphRagEnabled(getBooleanProperty("kompile.react.graph-rag-enabled", true))
                ...
                .evalBasedEnabled(getBooleanProperty("kompile.react.eval-based-enabled", true))
                ...
                .evaluateReasoning(getBooleanProperty("kompile.react.evaluate-reasoning", true))
