...
/**
 * REST controller for model listing, SameDiff inspection, and embedding testing.
 * Extracted from ModelDebugController.
 *
 * Endpoints:
 *   GET  /api/models/list
 *   GET  /api/models/samediff-embeddings/list
 *   GET  /api/models/samediff-embeddings/{modelIndex}/summary/text
 *   GET  /api/models/samediff/{beanName}/summary/text
 *   GET  /api/models/samediff-embeddings/{modelIndex}/summary
 *   GET  /api/models/samediff/{beanName}/summary
 *   GET  /api/models/embeddings/info
 *   POST /api/models/embeddings/test
 */
@RestController
        ...
        try {
            ...
            for (Map.Entry<String, Object> entry : allBeans.entrySet()) {
                ...
                if (beanName.startsWith("org.springframework") ||
                    ...
                    bean instanceof ModelDiscoveryController) {
                    continue;
                }
