import {
  createLabel_default
} from "./chunk-ZJOGJ56W.js";
import {
  at
} from "./chunk-P43MCBMI.js";
import {
  isLabelStyle,
  styles2String
} from "./chunk-DRAGW5OU.js";
import {
...
var insertEdgeLabel = /* @__PURE__ */ __name((elem, edge) => __async(null, null, function* () {
  ...
  if (edge.endLabelLeft) {
    ...
    const endLabelElement = yield createLabel_default(endEdgeLabelLeft, edge.endLabelLeft, getLabelStyles(edge.labelStyle) || "", false, false);
    fo = endLabelElement;
  ...
  if (edge.endLabelRight) {
    ...
    const endLabelElement = yield createLabel_default(endEdgeLabelRight, edge.endLabelRight, getLabelStyles(edge.labelStyle) || "", false, false);
    fo = endLabelElement;
    let slBox = endLabelElement.getBBox();
    if (useHtmlLabels) {
      const div = endLabelElement.children[0];
...
//# sourceMappingURL=chunk-QQKFSJ24.js.map
