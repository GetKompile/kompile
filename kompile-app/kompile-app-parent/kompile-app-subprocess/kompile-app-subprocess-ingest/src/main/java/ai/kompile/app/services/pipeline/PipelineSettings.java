 ...
 * @param enableGraphBuilding Legacy compatibility flag; graph building is mandatory and normalized true
...
public record PipelineSettings(
    ...
    public static PipelineSettings adaptive() {
        ...
        return new PipelineSettings(
                ...
                true,                        // enableGraphBuilding - mandatory
    ...
    public static PipelineSettings memoryOptimized() {
        return new PipelineSettings(
                ...
                true, 5,                     // graph building mandatory, small batch
    ...
    public static PipelineSettings highThroughput() {
        ...
        return new PipelineSettings(
                ...
                true, 20,                    // graph building mandatory, larger batch
                false, false, false, false, false, // concurrent extraction disabled
    ...
    public static PipelineSettings defaults() {
        return new PipelineSettings(
                ...
                true, DEFAULT_GRAPH_BUILDING_BATCH_SIZE,  // graph building
                false, false, false, false, false,        // concurrent extraction disabled
    ...
    public static class Builder {
        ...
        public Builder enableGraphBuilding(boolean ignored) {
