...
public class SubprocessIngestConfiguration {
    ...
    public IngestPipelineRunner ingestPipelineRunner(
        ...
        if (embeddingModel != null) {
            ...
            throw new IllegalStateException("No real embedding model available for ingest subprocess");
        }
        ...
        if (indexerService != null) {
            ...
            throw new IllegalStateException("No real IndexerService available for ingest subprocess");
        }
        ...
        if (vectorStore != null) {
            ...
            throw new IllegalStateException("No real VectorStore available for ingest subprocess");
        }
    ...
    /**
     * Fails context startup when vector ingestion has no real embedding model.
     */
    @Bean
    @ConditionalOnMissingBean(EmbeddingModel.class)
    public EmbeddingModel fallbackEmbeddingModel() {
        throw new IllegalStateException("No EmbeddingModel found in ingest subprocess context");
    }

    /**
     * Fails context startup when vector ingestion has no real indexer service.
     */
    @Bean
    @ConditionalOnMissingBean(IndexerService.class)
    public IndexerService fallbackIndexerService() {
        throw new IllegalStateException("No IndexerService found in ingest subprocess context");
    }

    /**
     * Fails context startup when vector ingestion has no real vector store.
     */
    @Bean
    @ConditionalOnMissingBean(VectorStore.class)
    public VectorStore fallbackVectorStore() {
        throw new IllegalStateException("No VectorStore found in ingest subprocess context");
    }
