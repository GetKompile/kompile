...
public class AgentChatRequest {
    ...
    /**
     * Optional fact sheet to scope grounded-answer verification against (grounded-RAG rec 1). When set
     * (and kbAnswerVerificationEnabled), the answer's claims are verified against this fact sheet's KB
     * after generation. Null = no verification (verifying against a wrong sheet would mislead).
     */
