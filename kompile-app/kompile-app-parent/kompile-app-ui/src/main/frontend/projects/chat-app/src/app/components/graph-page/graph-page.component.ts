...
/**
 * Top-level route wrapper for the chat app's /graph route.
 *
 ...
 * bundle. chatRoute is supplied because this app owns /chat, so "Ask about this graph" resolves.
 */
@Component({
  standalone: true,
  selector: 'app-graph-page',
  imports: [CommonModule, GraphExploreHubComponent],
  template: `<app-graph-explore-hub chatRoute="/chat"></app-graph-explore-hub>`
})
