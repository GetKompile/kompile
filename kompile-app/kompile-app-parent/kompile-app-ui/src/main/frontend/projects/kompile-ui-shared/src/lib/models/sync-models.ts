...
export type SyncRunStatus = 'QUEUED' | 'RUNNING' | 'COMPLETED' | 'PARTIAL' | 'ERROR' | 'INTERRUPTED';
...
export interface NoteSyncConfig {
  ...
  notionWebhookSecretConfigured: boolean;
...
export interface NoteSyncConfigUpdate {
  notionEnabled?: boolean;
...
export interface SyncRunResponse {
  ...
  errors: number;
  crawlJobId?: string;
  graphStatus?: 'NOT_REQUIRED' | 'PENDING' | 'QUEUED' | 'ERROR';
  graphError?: string;
