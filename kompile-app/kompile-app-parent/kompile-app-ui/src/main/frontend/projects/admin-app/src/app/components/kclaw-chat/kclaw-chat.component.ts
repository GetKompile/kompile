...
import { AgentDefinition, KClawChatResponse } from '@shared/models/kclaw-models';

@Component({
  selector: 'app-kclaw-chat',
  standalone: false,
  templateUrl: './kclaw-chat.component.html',
  styleUrls: ['./kclaw-chat.component.css']
})
export class KClawChatComponent implements OnInit, OnDestroy {
