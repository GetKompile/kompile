...
import { ProcessDiagramService, DiagramSession, TranscriptEntry } from '@shared/services/process-diagram.service';
...
import { ProvenanceCitation } from '@shared/models/graph-models';
