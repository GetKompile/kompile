...
describe('ToolsHubComponent', () => {
  ...
  beforeEach(async () => {
    await TestBed.configureTestingModule({
      ...
      // The hub reads its selected tool from the route and its services want HttpClient, so
      // both an ActivatedRoute and an HttpClient have to exist in the testing injector.
