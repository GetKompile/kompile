...
import { GitDiffService, GitCommit, GitFileDiff, GitStatus } from '@shared/services/git-diff.service';
import { DiffIndexService, DiffIndexEntry, DiffSession } from '@shared/services/diff-index.service';
