...
describe('Document Ingest Flow', () => {
  ...
  // Processing settings are configured in the admin console and consumed by the crawl manager,
  // so the read goes to admin. Reaching for cy.apiGet here would 404 against :8082 and read as a
  // crawl-manager regression rather than what it is — a call to the wrong process.
