 ...
 * Exposes indexing job history, ingest events and job logs.
 *
 * Subprocess event history used to live here too; it moved to {@code SubprocessEventHistoryTool} in
 * kompile-app-main because {@code SubprocessEventHistoryController} is an admin surface while the
 * indexing/ingest/log controllers are crawl surfaces. Tool names are unchanged on both sides.
