...
/**
 * KClaw-specific base channel adapter.
 * Extends the shared {@link ai.kompile.gateway.core.gateway.channel.BaseChannelAdapter}
 * and wires in the KClaw agent service as the executor.
 *
...
public abstract class BaseChannelAdapter
    ...
    /**
     * Convenience constructor that adapts {@link KClawAgentService} (which implements
     * {@link ai.kompile.gateway.core.service.AgentExecutor}) into the shared base class.
     */
    protected BaseChannelAdapter(KClawAgentService agentService) {
        super(agentService);
    }
}
