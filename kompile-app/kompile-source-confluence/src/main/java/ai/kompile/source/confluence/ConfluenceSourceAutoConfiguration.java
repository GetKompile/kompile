...
/**
 * Auto-configuration for Confluence source provider.
 */
@AutoConfiguration
public class ConfluenceSourceAutoConfiguration {

    @Bean
    public ConfluenceSourceProvider confluenceSourceProvider(
