...
expect linux-cuda-13.1 'BuildImage=[^ ]*:cuda-13.1'
...
expect linux-x86_64-avx512 'KompileVariant=cpu-intel'
expect linux-vulkan 'BuildKompile=false'
expect android-arm64-vulkan 'BuildKompile=false'
expect vulkan-smoke-linux 'EnvironmentType=LINUX_CONTAINER'
expect gpu-multidevice-linux 'ComputeType=BUILD_GENERAL1_LARGE'
expect gpu-multidevice-linux 'EnvironmentType=LINUX_GPU_CONTAINER'
expect linux-cuda-12.9-cudnn 'BuildImage=[^ ]*:cuda-12.9'
