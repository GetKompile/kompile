...
public class SpladePlusPlusSelfDistilSameDiffEncoder extends SpladePlusPlusSameDiffEncoder {
    ...
    // public static final String MODEL_ID_SPLADE_PP_SELF_DISTIL = "anserini_encoder_splade-pp-sd-onnx";
    ...
    public SpladePlusPlusSelfDistilSameDiffEncoder(
            ...
            int quantRange)
            throws IOException {
        super(modelIdentifier, // Pass the logical model identifier
        ...
        LOG.info("[{}] SpladePlusPlusSelfDistilSameDiffEncoder initialized.", modelIdentifier);
    }
