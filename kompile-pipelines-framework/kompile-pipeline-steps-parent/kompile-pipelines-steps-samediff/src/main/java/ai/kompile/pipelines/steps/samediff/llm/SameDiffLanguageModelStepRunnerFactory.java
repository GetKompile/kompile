    ...
    public StepSchema getSchema() {
        return StepSchema.builder()
                ...
                .parameters(Arrays.asList(
                        ...
                        ParameterSchema.builder().name("tokenizerConfig").type(ValueType.OBJECT).description("(Optional) Map of configurations for the tokenizer (e.g., unkToken, subwordPrefix).").subType(java.util.Map.class.getName()).required(false).build(),
                        ...
                        ParameterSchema.builder().name("toolDefinitions").type(ValueType.LIST).description("List of PipelineToolDefinition objects available to the LLM.").subType(PipelineToolDefinition.class.getName()).required(false).build(),
                        ...
                        ParameterSchema.builder().name("generationParameters").type(ValueType.OBJECT)
                                ...
                                .subType(java.util.Map.class.getName()).required(false).build()
                ))
                ...
                .outputs(Arrays.asList(
                        ...
                        ParameterSchema.builder().name("tool_call_request").type(PipelineToolCallRequest.class.getName()).description("Request for a tool call, if made by the LLM (if 'toolCallRequestOutputName' is 'tool_call_request').").required(false).build()
                ))
                .build();
    }
}