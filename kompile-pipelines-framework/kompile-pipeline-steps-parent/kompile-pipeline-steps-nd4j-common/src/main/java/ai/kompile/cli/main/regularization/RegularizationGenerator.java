...
public class RegularizationGenerator implements Callable<Integer> {
    ...
    private static final Logger log = LoggerFactory.getLogger(RegularizationGenerator.class);
    ...
    public Integer call() throws Exception {
        ...
        switch(regularizationType) {
            case "l2":
                if(l2Value != null)
                    ...
                    log.error("Please specify a regularization l2 coefficient or schedule.");
                    return 1;
                }
                break;
            case "l1":
                if(l1Value != null)
                    ...
                    log.error("Please specify a regularization l1 coefficient or schedule.");
                    return 1;
                }
                break;
            case "weightdecay":
                if(weightDecayCoefficient != null && applyLearningRateWeightDecay != null) {
                    ...
                    log.error("weightdecay regularization specified, but missing either schedule, weightDecayCoefficient, or applyLearningRateWeightDecay arguments. Specify all to create a valid regularization configuration.");
                }
                break;
        ...
        if(regularization == null) {
            log.error("Invalid regularization configuration. Exiting.");
            return 1;
        }
