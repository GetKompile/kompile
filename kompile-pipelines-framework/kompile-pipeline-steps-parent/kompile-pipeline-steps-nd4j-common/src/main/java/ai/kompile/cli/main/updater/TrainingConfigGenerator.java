...
package ai.kompile.cli.main.updater;

import ai.kompile.cli.main.DataTypeConverter;
import ai.kompile.cli.main.regularization.RegularizationConverter;
...
public class TrainingConfigGenerator implements Callable<Integer> {
    ...
    public Integer call() throws Exception {
        ...
        if(lossVariables != null)
            trainingConfigBuilder.minimize(true);
        ...
        System.out.println(ObjectMappers.getJsonMapper().convertValue(trainingConfig,TrainingConfig.class));
        return 0;
    }
